...
- **Production verification status:** Partially verified on 2026-09-02 at deployed commit `87a8d311bec08d33ec709d793184f0faecf3101f`: the consistently labelled Admin action appeared in Surveys and was absent from the Admin infrastructure screen. Non-Admin production rendering/direct-call rejection was not exercised against a real non-Admin account; automated authorization tests passed, so manual production verification remains pending.
- **Relevant commit:** `4d3fd18e6d024e61c0d1564864dd5e2a432d6808`
...
- **Production verification status:** Partially verified on 2026-09-02 at deployed commit `87a8d311bec08d33ec709d793184f0faecf3101f`: the production Admin screen displayed the plain-language operational purpose, an explanatory empty quota-table state, exactly four supported provider/quota choices, and high-usage capacity-selection explanation; the bulk survey action was absent from this screen. A production reconciliation was not submitted because it would alter operational quota state, so manual functional verification remains pending.
- **Relevant commit:** `4d3fd18e6d024e61c0d1564864dd5e2a432d6808`
